...
import { useGetCartQuery, useRemoveFromCartMutation, useClearCartMutation } from "@/app/store/reducers/cart/api";
                    ...
                    <div className="container py-10 mt-20">
                        ...
                        {isLoading ? (
                            ...
                            <div className="text-center py-20">
                                <p className="text-18 mb-20">Your cart is empty</p>
                                <Link
                                    href="/courses"
                            ...
                            <div className="row y-gap-30">
                                <div className="col-lg-8">
                                    {cart?.items.map((item) => (
                                        <div key={item.id} className="border rounded-8 p-20 mb-20">
                                            <div className="row y-gap-20 justify-between p-3">
                                                ...
                                                <div className="col-md-6">
                                                    <h3 className="text-18 fw-500">
                                                        {item.course?.title || "Course Title Not Available"}
                                                    </h3>
                                                    {!item.course && (
                                                        <p className="text-14 text-red-1 mt-10">
                                                            Course details not available. This course may have been
                                                            removed.
                                                        </p>
                                                    )}
                                                </div>
                                                <div className="col-md-3 text-right">
                                                    ...
                                                    <button
                                                        onClick={() =>
                                                            handleRemoveItem(item.course?.id || item.course_id)
                                                        }
                                ...
                                <div className="col-lg-4">
                                    <div className="border rounded-8 p-3">
                                        <h3 className="text-20 fw-600 mb-20">Cart Summary</h3>
                                        <div className="d-flex justify-between mb-20">
                                            <span>Total:</span>
                                            <span className="text-20 fw-600">${totalAmount.toFixed(2)}</span>
                                        </div>
                                        <Link href="/checkout" className="button -md -dark-1 text-white w-1/1 mb-10">
                                            Checkout
                                        </Link>
                                        <button
